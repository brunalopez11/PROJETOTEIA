    ...
    <main className="aluno-container">
      ...
      <section className="cursos-section">
        ...
        <div className="cursos-grid">
          <a href="https://youtu.be/PKwu15ldZ7k" target="_blank" className="curso-card">
            <h3>HTML + CSS Completo</h3>
            <p>Aula completa para iniciantes</p>
          </a>

          <a href="https://youtu.be/3PHXvlpOkf4" target="_blank" className="curso-card">
            <h3>JavaScript Iniciante</h3>
            <p>Fundamentos essenciais</p>
          </a>

          <a href="https://youtu.be/j942wKiXFu8" target="_blank" className="curso-card">
            <h3>React do Zero</h3>
